...
export default function PostPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="container px-5 py-12 mx-auto -mt-28">
        <div className="flex flex-wrap -m-4 max-w-6xl">
...
{`(async () => {
    try {
        await upsertSchemasOnMdm(schemasDirectory);
        process.exit(0);
    } catch (exception) {
        LoggerFactory.getLogger().error(\`putSchemasOnMdmCli - \${exception}\`);
        process.exit(1);
    }
})();`}
                        </code>
