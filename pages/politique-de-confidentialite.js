    ...
    <div>
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-8 py-5 bg-white dark:bg-gray-800 rounded-lg shadow-md">
            ...
            <p className ="mt-5">Conformément à la loi Informatique et Libertés n°78-17 du 6 janvier 1978 modifiée et au Règlement Général sur la Protection des Données à caractère personnel (ci-après « RGPD ») n° 2016/679/UE du 27 avril 2016, RBBM.Tech, en qualité de responsable de traitement, garantit le respect de la vie privée des Utilisateurs du Site.</p>
