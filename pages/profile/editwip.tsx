...
const subNavigation = [
  ...
  { name: 'Expériences', href: '#', icon: BriefcaseIcon, current: false },
  { name: 'Compétences', href: '#', icon: KeyIcon, current: false },
...
const ProfileEdit: React.FC = ({data}) => {
const router = useRouter()
  const userId = data.auth_id
  const delayedHandleChange = debounce((action,event) => {
  ...
  const [availableForHire, setAvailableToHire] = useState(data.availableForHire ?? false)
  const [privateAccount, setPrivateAccount] = useState(data.privateAccount ?? false)

  const savePofile = async (id, data) => {
    await axios.patch(`${process.env.NEXT_PUBLIC_URL}/api/users/${id}`,data )
    router.push('/profile')
  }
  return (
    <div>
                      ...
                      <Menu as="div" className="relative flex-shrink-0 ml-4">
                        <div>
                          <Menu.Button className="rounded-full flex text-sm text-white focus:outline-none focus:bg-sky-900 focus:ring-2 focus:ring-offset-2 focus:ring-offset-sky-900 focus:ring-white">
                            ...
                            <img className="rounded-full h-8 w-8" src={data.picture} alt="" />
                          </Menu.Button>
                        </div>
                        <Transition
                          as={Fragment}
              ...
              <Disclosure.Panel className="bg-sky-900 lg:hidden">
                ...
                <div className="pt-4 pb-3 border-t border-sky-800">
                  <div className="flex items-center px-4">
                    <div className="flex-shrink-0">
                      <img className="rounded-full h-10 w-10" src={data.picture} alt="" />
                    </div>
                    <div className="ml-3">
                      <div className="text-base font-medium text-white">{data.name}</div>
                      <div className="text-sm font-medium text-sky-200">{data.email}</div>
                    </div>
                    <button
                      type="button"
              ...
              <form className="divide-y divide-gray-200 lg:col-span-9" action="#" method="POST">
                ...
                <div className="py-6 px-4 sm:p-6 lg:pb-8">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Ces informations seront publiées sur ta page profil
                    </p>
                  </div>
                  ...
                  <div className="mt-6 flex flex-col lg:flex-row">
                      ...
                      <div>
                        ...
                        <div className="mt-1 rounded-md shadow-sm flex">
                          <span className="bg-gray-50 border border-r-0 border-gray-300 rounded-l-md px-3 inline-flex items-center text-gray-500 sm:text-sm">
                            practicalprogramming.fr/profile/
                          </span>
                          <input
                            type="text"
                            name="username"
                      ...
                      <div>
                        ...
                        <div className="mt-1">
                          <textarea
                            ...
                            placeholder="Développeur Javascript/Typescript passionné par la blockchain"
                            defaultValue={description}
                            onChange={(e) => {delayedHandleChange(setDescription,e)}}
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-6 flex-grow lg:mt-0 lg:ml-6 lg:flex-grow-0 lg:flex-shrink-0">
                      ...
                      <div className="mt-1 lg:hidden">
                        <div className="flex items-center">
                          <div
                            ...
                            aria-hidden="true"
                          >
                            <img className="rounded-full h-full w-full" src={data.picture} alt="" />
                          </div>
                      ...
                      <div className="hidden relative rounded-full overflow-hidden lg:block">
                        <img className="relative rounded-full w-40 h-40" src={data.picture} alt="" />
                        <label
                  ...
                  <div className="mt-6 grid grid-cols-12 gap-6">
                    <div className="col-span-12 sm:col-span-6">
                      ...
                      <input
                        ...
                        onChange={(e) => {delayedHandleChange(setFirstName,e)}}
                      />
                    </div>
                    ...
                    <div className="col-span-12 sm:col-span-6">
                      ...
                      <input
                        ...
                        onChange={(e) => {setLastName(setDescription,e)}}
                      />
                    </div>
                    ...
                    <div className="col-span-12">
                      ...
                      <input
                        ...
                        id="url"
                        className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm"
                        onChange={(e) => {delayedHandleChange(setLinkedin,e)}}
                    ...
                    <div className="col-span-12">
                      ...
                      <input
                        ...
                        id="url"
                        className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm"
                        onChange={(e) => {delayedHandleChange(setTwitter,e)}}
                    ...
                    <div className="col-span-12">
                      ...
                      <input
                        ...
                        onChange={(e) => {delayedHandleChange(setBlog,e)}}
                      />
                    </div>
                  </div>
                </div>
                <div className="pt-6 divide-y divide-gray-200">
                  <div className="px-4 sm:px-6">
                    <div>
                      <h2 className="text-lg leading-6 font-medium text-gray-900">Intérêts</h2>
                      <p className="mt-1 text-sm text-gray-500">
                        Sélectionne les sujets qui t'intéressent
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-6 divide-y divide-gray-200">
                    ...
                    <ul role="list" className="mt-2 divide-y divide-gray-200">
                      <Switch.Group as="li" className="py-4 flex items-center justify-between">
                        <div className="flex flex-col">
                          ...
                          <Switch.Description className="text-sm text-gray-500">
                            En activant cette option, tu permets aux recruteurs de te contacter
                          </Switch.Description>
                        </div>
                        <Switch
                          ...
                          className={classNames(
                            availableForHire ? 'bg-teal-500' : 'bg-gray-200',
                      ...
                      <Switch.Group as="li" className="py-4 flex items-center justify-between">
                        <div className="flex flex-col">
                          ...
                          <Switch.Description className="text-sm text-gray-500">
                            En activant cette option, ton profil sera invisible pour tous les utilisateurs de Practical Programming
                          </Switch.Description>
                        </div>
                        <Switch
                      ...
                      <button
                      type="submit"
                      className="ml-5 bg-red-700 border border-transparent rounded-md shadow-sm py-2 px-4 inline-flex justify-center text-sm font-medium text-white hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500"
                    >
                  ...
                  <div className="mt-4 py-4 px-4 flex justify-end sm:px-6">
                    ...
                    <button
                      ...
                      onClick={e => {
                          e.preventDefault()
                          console.log({description,linkedin,blog,twitter,firstName,lastName})
                          savePofile(data.auth_id,{description,linkedin,blog,twitter,firstName,lastName})
                        }}
                    >
                      Save
                    </button>
...
export const getServerSideProps = withPageAuthRequired({
    getServerSideProps: async function getServerSideProps(ctx) {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_URL}/api/users/${session.user.sub}`)
