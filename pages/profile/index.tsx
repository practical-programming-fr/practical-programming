                          ...
                          <div className="pt-4 pb-2">
                            <div className="flex items-center px-5">
                              <div className="flex-shrink-0">
                                <Image width={80} height={80} className="h-10 w-10 rounded-full" src={user.picture} alt={user.name} />
                              </div>
                      ...
                      <div className="bg-white p-6">
                        <div className="sm:flex sm:items-center sm:justify-between">
                          <div className="sm:flex sm:space-x-5">
                            <div className="flex-shrink-0">
                              <img className="mx-auto h-20 w-20 rounded-full" src={user.picture} alt="" />
                            </div>
                            <div className="flex justify-center items-center text-center sm:mt-0 sm:pt-1 sm:text-left">
                              <p className="text-xl font-bold text-gray-900 sm:text-2xl">Bonjour {user.given_name} 👋 </p>
                            </div>
                          </div>
