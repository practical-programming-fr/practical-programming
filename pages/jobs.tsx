                    ...
                    <div>
                      <div className="ml-5">
                        ...
                        <div className="flex">
                          ...
                          <p className="text-gray-700 hover:underline mr-5">
                    ...
                    <div className="flex">
                      ...
                      <div className="flex justify-between items-center mt-4">
                        <div>
                          <a
                            href="#"
                            className="mr-2 px-2 py-1 bg-gray-600 text-gray-100 font-bold rounded hover:bg-gray-500"
                          >
                            PHP
                          </a>
                          <a
                ...
                <div className="max-w-4xl px-10 py-6 bg-white rounded-lg shadow-md">
                  ...
                  <div className="mt-2">
                    ...
                    <p className="mt-2 text-gray-600">
                      ...
                      dicta totam aspernatur doloremque. Excepturi iste iusto eos enim reprehenderit
                      nisi, accusamus delectus nihil quis facere in modi ratione libero!
                    </p>
                  </div>
                  <div className="flex justify-between items-center mt-4">
                ...
                <div className="flex flex-col bg-white px-8 py-6 max-w-sm mx-auto rounded-lg shadow-md">
                  ...
                  <div className="mt-4">
                    <a href="#" className="text-lg text-gray-700 font-medium hover:underline">
                      Build Comment réussir à démarrer sa carrière de développeur
                    </a>
                  </div>
                  <div className="flex justify-between items-center mt-4">
