        ...
        <div className="space-y-12 lg:grid lg:grid-cols-5 lg:gap-8 lg:space-y-0">
          <div className="space-y-5 sm:space-y-4 lg:col-span-3">
            <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl">
              L'équipe Tech chez Shine ou une autre super boite
            </h2>
              ...
              <li className="sm:py-8">
                <div className="space-y-4 sm:grid sm:grid-cols-3 sm:items-start sm:gap-6 sm:space-y-0">
                  ...
                  <div className="aspect-w-3 aspect-h-2 sm:aspect-w-3 sm:aspect-h-4">
                    <img
                      className="object-cover shadow-lg rounded-lg"
                      src="https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?ixlib=rb-1.2.1&ixqx=xNLzUn5i0j&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=128&h=128&q=80"
                      alt
                    />
                  </div>
                  <div className="sm:col-span-2">
