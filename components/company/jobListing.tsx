...
const JobListing: React.FC<any> = ({ job }) => {
  return (
    <>
      <Link href={`/entreprise/${job.hiringCompany.slug}/jobs/${job.slug.current}`}>
        <div className="mt-4 bg-white dark:bg-dark-gray px-4 py-4 rounded-md border-gray-100 dark:border-brand border-2 border-transparent hover:border-blue-500 dark:hover:border-orange-link shadow-lg cursor-pointer">
          <div>
