          ...
          <Link href="/developpeur-en-cdi">
            <a>
              <p className="text-blue-700 dark:text-blue-900 font-light text-md mt-2">
                ...
                son premier poste. Plus de deux tiers des candidats abandonnent après une ou
                plusieurs formations accélérées faute d{`'`}avoir trouvé un CDI pour démarrer leurs
                carrières.
              </p>
              <p className="text-blue-700 dark:text-blue-900 font-medium text-md mt-6">
                Découvrez le programme Practical Programming qui vous accompagne de votre
                reconversion jusqu{`'`}à la signature de votre premier CDI.
              </p>
            </a>
          </Link>
        </div>
