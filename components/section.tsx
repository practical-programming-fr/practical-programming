...
const Section: React.FC = ({ posts }) => {
  return (
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-6 mx-auto lg:max-w-5xl">
        <h2 className="sm:text-2xl text-xl title-font font-medium text-gray-900 mb-8">
          Section Articles
        </h2>
            ...
            return (
              <div className="p-4 md:w-1/2" key={post._id}>
                <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                  ...
                  />
                  <div className="p-6">
                    <h3 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1 uppercase"></h3>
                    <h2 className="title-font text-lg font-medium text-gray-900 mb-3 uppercase">
                      {post.title}
                    </h2>
