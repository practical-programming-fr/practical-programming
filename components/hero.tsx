    ...
    <section className="bg-gray-100 dark:bg-gray-900 lg:py-12 lg:flex lg:justify-center">
      <div className="bg-white dark:bg-gray-800 lg:mx-8 lg:flex lg:max-w-5xl lg:shadow-lg lg:rounded-lg">
        ...
        <div className="py-12 px-6 max-w-xl lg:max-w-5xl lg:w-1/2">
          <h2 className="text-2xl text-gray-800 dark:text-white font-bold md:text-3xl">
          ...
          <div className="mt-8">
            <a
              href="#"
              className="bg-gray-900 text-gray-100 px-5 py-3 font-semibold rounded hover:bg-gray-800"
            >
              Start Now
            </a>
          </div>
